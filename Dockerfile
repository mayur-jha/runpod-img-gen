...
# Existing LoRAs
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_pussy_spread.safetensors -O flux_pussy_spread.safetensors
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_dildo_riding.safetensors -O flux_dildo_riding.safetensors
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_dildo_insertion.safetensors -O flux_dildo_insertion.safetensors
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_fingering.safetensors -O flux_fingering.safetensors
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_nsfw.safetensors -O flux_nsfw.safetensors
RUN wget --content-disposition https://fluxloraimage.s3.us-east-1.amazonaws.com/flux_real.safetensors -O flux_real.safetensors
