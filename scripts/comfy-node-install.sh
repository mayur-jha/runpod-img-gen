...
log="comfy-node-install-$(date +%Y%m%d-%H%M%S).log"
echo "Saving installation log to: $log" >&2
...
echo "Installation completed. Full log saved to: $log" >&2
exit 0